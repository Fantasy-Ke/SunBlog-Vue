...
export class PictureSsServiceProxy {
   ...
   */
  getPage(
    body: PicturesPageQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<PicturesPageOutputPageResult>> {
...
export class FriendLinksServiceProxy {
   ...
   */
  getPage(
    body: FriendLinkPageQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<FriendLinkPageOutputPageResult>> {
...
export class FilesServiceProxy {
  ...
  protected processUploadFile(response: AxiosResponse): Promise<ZEngineResponse<UploadFileOutput[]>> {
    ...
    if (status === 200) {
      ...
      if (Array.isArray(resultData200)) {
        result200 = [] as any;
        for (let item of resultData200) result200.push(UploadFileOutput.fromJS(item));
      } else {
        result200 = <any>null;
      }
      result200Data = ZEngineResponse.fromJS(_responseText);
  ...
  getFile(fileUrl: string | undefined, cancelToken?: CancelToken): Promise<ZEngineResponse<void>> {
    ...
    if (fileUrl === null) throw new Error("The parameter 'fileUrl' cannot be null.");
    else if (fileUrl !== undefined) url_ += "fileUrl=" + encodeURIComponent("" + fileUrl) + "&";
    url_ = url_.replace(/[?&]$/, "");
...
export class CustomConfigsServiceProxy {
   ...
   */
  getPage(
    body: CustomConfigQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<CustomConfigPageOutputPageResult>> {
   ...
   */
  getFormJson(
    body: GetConfigDetailInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<CustomConfigDetailOutput>> {
...
export class CategorySsServiceProxy {
  ...
  protected processGetPage(response: AxiosResponse): Promise<ZEngineResponse<CategoryPageOutput[]>> {
    ...
    if (status === 200) {
      ...
      if (Array.isArray(resultData200)) {
        result200 = [] as any;
        for (let item of resultData200) result200.push(CategoryPageOutput.fromJS(item));
      } else {
        result200 = <any>null;
      }
      result200Data = ZEngineResponse.fromJS(_responseText);
...
export class AuthAccountsServiceProxy {
   ...
   */
  getList(
    body: AuthAccountPageQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<AuthAccountPageOutputPageResult>> {
...
export class ArticleSsServiceProxy {
   ...
   */
  getPage(
    body: ArticlePageQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<ArticlePageOutputPageResult>> {
...
export class AlbumsSsServiceProxy {
   ...
   */
  getPage(
    body: AlbumsPageQueryInput | undefined,
    cancelToken?: CancelToken
  ): Promise<ZEngineResponse<AlbumsPageOutputPageResult>> {
...
export class AuthAccountPageOutputPageResult implements IAuthAccountPageOutputPageResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["rows"])) {
        this.rows = [] as any;
        for (let item of _data["rows"]) this.rows.push(AuthAccountPageOutput.fromJS(item));
      }
    }
  }
...
export class BloggerInfo implements IBloggerInfo {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["avatar"])) {
        this.avatar = [] as any;
        for (let item of _data["avatar"]) this.avatar.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.avatar)) {
      data["avatar"] = [];
      for (let item of this.avatar) data["avatar"].push(item);
    }
...
export class BlogSetting implements IBlogSetting {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["logo"])) {
        this.logo = [] as any;
        for (let item of _data["logo"]) this.logo.push(item);
      }
      this.logoUrl = _data["logoUrl"];
      if (Array.isArray(_data["favicon"])) {
        this.favicon = [] as any;
        for (let item of _data["favicon"]) this.favicon.push(item);
      }
      this.faviconUrl = _data["faviconUrl"];
      this.isRewards = _data["isRewards"];
      if (Array.isArray(_data["aliPay"])) {
        this.aliPay = [] as any;
        for (let item of _data["aliPay"]) this.aliPay.push(item);
      }
      this.aliPayUrl = _data["aliPayUrl"];
      if (Array.isArray(_data["wxPay"])) {
        this.wxPay = [] as any;
        for (let item of _data["wxPay"]) this.wxPay.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.logo)) {
      data["logo"] = [];
      for (let item of this.logo) data["logo"].push(item);
    }
    data["logoUrl"] = this.logoUrl;
    if (Array.isArray(this.favicon)) {
      data["favicon"] = [];
      for (let item of this.favicon) data["favicon"].push(item);
    }
    data["faviconUrl"] = this.faviconUrl;
    data["isRewards"] = this.isRewards;
    if (Array.isArray(this.aliPay)) {
      data["aliPay"] = [];
      for (let item of this.aliPay) data["aliPay"].push(item);
    }
    data["aliPayUrl"] = this.aliPayUrl;
    if (Array.isArray(this.wxPay)) {
      data["wxPay"] = [];
      for (let item of this.wxPay) data["wxPay"].push(item);
    }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["children"])) {
        ...
        for (let item of _data["children"]) this.children.push(CategoryPageOutput.fromJS(item));
      }
    }
  }
...
export class CustomConfigPageOutput implements ICustomConfigPageOutput {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["configItemId"])) {
        ...
        for (let item of _data["configItemId"]) this.configItemId.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.configItemId)) {
      data["configItemId"] = [];
      for (let item of this.configItemId) data["configItemId"].push(item);
    }
...
export class CustomConfigPageOutputPageResult implements ICustomConfigPageOutputPageResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["rows"])) {
        this.rows = [] as any;
        for (let item of _data["rows"]) this.rows.push(CustomConfigPageOutput.fromJS(item));
      }
    }
  }
...
export class PicturesPageOutputPageResult implements IPicturesPageOutputPageResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["rows"])) {
        this.rows = [] as any;
        for (let item of _data["rows"]) this.rows.push(PicturesPageOutput.fromJS(item));
      }
    }
  }
